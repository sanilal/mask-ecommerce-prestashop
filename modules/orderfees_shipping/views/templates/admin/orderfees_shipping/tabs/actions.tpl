...
<div class="form-group" data-type="{ShippingRule::IS_FORMULA|intval}">
    ...
    <div class="col-lg-8">
        ...
        <span class="help-block">{l s='For example, $15 for the first product and $5 for each additional products : [1]15 + (5 * (quantity - 1))[/1]' tags=['<strong>'] mod='orderfees_shipping'}</span>
    </div>
</div>
